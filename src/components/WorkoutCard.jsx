...
function WorkoutCard({ workout, onComplete }) {
  ...
  return (
    <div className="workout-card bg-white rounded-lg shadow-sm border border-calm-200 p-6 hover:shadow-md">
      ...
      <p className="text-calm-700 mb-4">{workout.description}</p>
